...
// 18 September 2026 00:00:00 IST = UTC 17 Sep 18:30:00
...
//           {/* Desktop: all 4 tickets exactly as before */}
//           <div className="hidden sm:flex mt-12 flex-row flex-nowrap items-center justify-center gap-4">
//             {["/1.png", "/2.png", "/3.png", "/4.png"].map((src, i) => (
//               <img
//                 key={i}
//                 src={src}
...
//           {/* Mobile: only 1.png, 3.png, 4.png — larger */}
//           <div className="flex sm:hidden mt-12 flex-row flex-nowrap items-center justify-center gap-3">
//             {["/1.png", "/3.png", "/4.png"].map((src, i) => (
//               <img
//                 key={i}
//                 src={src}
//                 alt={`Free Pass Ticket`}
//                 className="h-auto w-auto max-h-[280px] max-w-[32%] rounded-lg object-contain"
//               />
//             ))}
//           </div>
//         </div>
